...
import com.mitha.argearcamera.ui.adapter.BeautyListAdapter;
import com.mitha.argearcamera.ui.widget.CustomSeekBar;
...
public class BeautyFragment
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mBeautyItemData = ((CameraActivity)getActivity()).getBeautyItemData();
    ...
    private void zeroBeautyParam() {
        ((CameraActivity) getActivity()).setBeauty(new float[ARGContents.BEAUTY_TYPE_NUM]);
    }
